        ...
        <Box className="out">
          <Box className="box-image" noMarginBottom>
            <Box className="imaggee" noMarginBottom>
              <HeroImage
                className="image-abs"
                imageSource={data.homepage.publicURL}
              />
            </Box>
            <Box className="text-about" isColumn noMarginBottom>
              <StyledTitle>O nas</StyledTitle>
              <p>
                Zakład został założony przez Karola Janika w 1948 roku. Od 1998
                roku zakład prowadzi jego córka Bernadetta wraz z mężem,
                Andrzejem.
              </p>
              <br></br>
              <br></br>
              <p>
                Od początku swojego istnienia kładziemy szczególny nacisk na
                jakość wykonywanych przez nas usług. Wszystkie zlecenia
                wykonujemy jak najlepiej i jak najszybciej. O jakości
    ...
    <Box isColumn>
      <BoxWIthImageStyles imageSource={data.offer.publicURL}>
        <Box isColumn className="text-box">
          ...
          <Link to="/oferta/#oferta">
            <ButtonStyled>Zobacz więcej</ButtonStyled>
          </Link>
        </Box>
