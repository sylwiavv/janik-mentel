...
const Galeria = ({
  ...
  <Box
    isColumn
    style={{ maxWidth: '990px', margin: '0 auto', padding: '0px 16px' }}
  >
    <Box isColumn id="galeria" style={{ width: '100%' }}>
      <StyledTitle>Galeria</StyledTitle>
      <p>
        Zapraszamy do obejrzenia zdjęć z sesji zdjęciowych wykonanych przez
        nasze studio.
      </p>
    </Box>

    <GalleryContainer paddingRight="0" style={{ width: '100%' }}>
      {nodes.map((n) => (
          ...
          >
            ...
            <Box className="page-link__img" isGap noMarginBottom>
              <div className="page-link__img-inner">
                <img
                  src={n.galleryAssets[0].file.url}
                  alt=""
                  loading="lazy"
                  className="first"
                />
